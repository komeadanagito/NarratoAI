...
""".strip()
        ...
        self.assertEqual("doubao-seed-2-1-turbo-260628", config_data["app"]["vision_openai_model_name"])
        self.assertEqual("https://ark.cn-beijing.volces.com/api/v3", config_data["app"]["vision_openai_base_url"])
        ...
        self.assertEqual("doubao-seed-2-1-turbo-260628", config_data["app"]["text_openai_model_name"])
        self.assertEqual("https://ark.cn-beijing.volces.com/api/v3", config_data["app"]["text_openai_base_url"])
        self.assertEqual(1.0, config_data["app"]["text_openai_temperature"])
        self.assertEqual(0.95, config_data["app"]["text_openai_top_p"])
        self.assertEqual("doubao-seed-2-1-turbo-260628", saved_config["app"]["vision_openai_model_name"])
        self.assertEqual("doubao-seed-2-1-turbo-260628", saved_config["app"]["text_openai_model_name"])
